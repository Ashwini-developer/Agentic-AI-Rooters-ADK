...
Use this data to personalize your trading strategy recommendations and ensure they are relevant to the user's financial situation and the current macro/micro/geopolitical context. If any of these are missing, proceed with available data.
