...
Use this data to personalize your execution plan and ensure it is relevant to the user's financial situation and the current macro/micro/geopolitical context. If any of these are missing, proceed with available data.
